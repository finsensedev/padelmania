...
export default function CustomerRoutes() {
  ...
  return (
    <div className="flex h-[100dvh] bg-background lg:flex-row flex-col">
      <CustomerSidebar />
      <main className="flex-1 overflow-y-auto">
        ...
        <button
          ...
          className="fixed right-4 bottom-4 bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg transition-all duration-200 ease-in-out hover:scale-105 flex items-center gap-2 z-50"
