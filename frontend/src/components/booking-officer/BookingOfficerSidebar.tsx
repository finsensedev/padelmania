...
const NAV_ITEMS = [
  ...
  { label: "Availability", path: "/booking-officer/availability", icon: Clock },
  {
...
export default function BookingOfficerSidebar() {
    ...
    <div className="h-full flex flex-col bg-sidebar border-r border-sidebar-border w-64 shadow-lg md:shadow-none">
      ...
      <div className="p-4 border-b border-sidebar-border flex items-center gap-3 bg-sidebar/50">
        ...
        <div>
          ...
          <p className="text-xs text-sidebar-foreground/60">Booking Officer</p>
        </div>
      </div>
    ...
    return (
      <>
        ...
        <motion.button
          ...
          className="fixed top-4  left-4 z-50 p-2.5 bg-background border-2 border-border rounded-lg md:hidden shadow-lg hover:bg-accent transition-colors"
